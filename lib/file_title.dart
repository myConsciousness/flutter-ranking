...
Currently, the top ${_getPackageCount(type)} packages are listed in this ranking, sorted by popularity index as evaluated by [pub.dev](https://pub.dev). This process is fully automated and ranking is recalculated daily per 3 hours based on UTC time ✨
